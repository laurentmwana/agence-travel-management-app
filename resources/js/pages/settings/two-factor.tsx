                    ...
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                vous serez invité à entrer un code sécurisé et
                                aléatoire lors de la connexion, que vous pourrez
                                récupérer depuis l’application compatible TOTP
                                sur votre téléphone.
                            </p>
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                facteurs, vous serez invité à entrer un code
